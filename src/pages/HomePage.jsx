...
const T = {
  es: {
    ...
    projectDescs: [
      ...
      'Regresión logística con 64,0 % de acierto y AUC-ROC 0,703. Señala qué empuja a los clientes a irse: el tipo de contrato, las incidencias y la factura.',
  ...
  en: {
    ...
    projectDescs: [
      ...
      'Logistic regression with 64.0% accuracy and 0.703 AUC-ROC. Shows what pushes customers out: contract type, support tickets and the bill.',
