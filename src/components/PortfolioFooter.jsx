  ...
  return (
    <footer>
      ...
      <div className="footer-links">
        <a href={IDENTIDAD.urlLinkedIn} target="_blank" rel="noreferrer" className="footer-link">
          ...
          {/* Ni el rotulo ni el destino se escriben aqui: los pone
              identidad.js, y en la version publicable no salen del dominio
              de la empresa. */}
          <span className="footer-link-text">{IDENTIDAD.rotuloLinkedIn}</span>
        </a>
        <span className="footer-sep">&middot;</span>
        <a href={IDENTIDAD.urlGitHub} target="_blank" rel="noreferrer" className="footer-link">
          ...
          <span className="footer-link-text">{IDENTIDAD.rotuloGitHub}</span>
        </a>
        <span className="footer-sep">&middot;</span>
      ...
      <p className="footer-built">{BUILT[lang]} <a href="https://mindset-code.com/es" target="_blank" rel="noreferrer">Mindset &amp; Code</a>{IDENTIDAD.firmaPie} · El Prat de Llobregat, Barcelona</p>
    </footer>
  )
}
