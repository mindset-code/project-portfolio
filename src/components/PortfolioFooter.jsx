    ...
    <footer>
      ...
      <div className="footer-links">
        ...
        <a href="https://github.com/mindset-code" target="_blank" rel="noreferrer" className="footer-link">
          ...
          {/* Igual que con LinkedIn: la direccion completa se leia como nombre
              propio. Cuando los repos esten en la organizacion, el href se
              actualiza y aqui no habra que tocar nada. */}
